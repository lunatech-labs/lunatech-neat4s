package less.stupid.neat.akkastreams
...
import less.stupid.neat.NEAT.ActivationFunction
import less.stupid.neat.akkastreams.NetworkNode.OutputValueCollector.OutputValueCollectorShape
